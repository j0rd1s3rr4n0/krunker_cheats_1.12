...
// @version 1.95
// @author Parthenoun
// @homepage https://brokeware.github.io
// @match *.krunker.io/*
// @exclude *krunker.io/social*
// @updateURL https://brokeware.github.io/js/Skidfest.user.js
...
function myFunction() {
  var person = prompt("Please enter your name", "HACKERMAN");
  if (person != null) {
   alert("¿Listo Para la Nuke " + person + "? A DARLE DUROO!");
   alert("Presiona F1 para activar el movo Formula 1 😂😏🖤");
  }
}
myFunction()
//document.body.innerHTML = document.body.innerHTML.replace('CLICK TO PLAY', 'Hacked By NSA');
